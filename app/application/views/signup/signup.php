      ...
      <div class="container-sm-height full-height">
        <div class="row row-sm-height">
          <div class="col-sm-12 col-sm-height col-middle">
            ...
            <form id="form-register" class="p-t-15" name="register" method="post" enctype="multipart/form-data">
              <h2 class="form-signup-heading">Sign Up</h2>
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group form-group-default">
                          <div id="image-holder" class="placeholder">
                            <img style="margin-left: 30%;"src="<?php echo '../../assets/images/'.$gender.'-profile.png'?>" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
                          </div>
...
$(document).ready(function() {
      ...
      function username_verifier(){
        ...
        if(username.length > 0 ){
          $.ajax({
                url: "<?php echo 'http://'.site_url('index.php/dashboard/usernameCheck/')?>" + username,
                type: 'GET',
                dataType: 'JSON'
           })
      ...
      function email_verifier(){
        ...
        if(mail.length > 0 ){
          $.ajax({
                url: "<?php echo 'http://'.site_url('index.php/dashboard/emailCheck/')?>" + email+"/"+company+"/"+domain,
                type: 'GET',
                dataType: 'JSON'
           })
           .done(function(response){
