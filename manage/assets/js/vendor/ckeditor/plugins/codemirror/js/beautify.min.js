...
a.token_type;a.last_text=a.token_text}return D=a.output.join("").replace(/[\r\n\t ]+$/,""),f&&(D+="\n"),D}if("function"==typeof define&&define.amd)define(["require","./beautify.min","./beautify-css"],function(s){var e=s("./beautify"),y=s("./beautify-css");return{html_beautify:function(s, a){return v(s,a,e.js_beautify,y.css_beautify)}}});else if("undefined"!=typeof exports){var y=require("./beautify.js"),H=require("./beautify-css.js");exports.html_beautify=function(s, e){return v(s,e,y.js_beautify,H.css_beautify)}}else"undefined"!=
